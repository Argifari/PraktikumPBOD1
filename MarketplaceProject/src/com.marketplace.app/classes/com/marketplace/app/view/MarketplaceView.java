...
public class MarketplaceView {
    ...
    private JButton btnBatalModal; // Tombol Batal baru sesuai gambar
    ...
    private final Color BRAND_PRIMARY = Color.decode("#2b1dc1"); // Warna ungu/biru gelap di tombol simpan gambar Anda
    private final Color BRAND_ON_PRIMARY = Color.decode("#ffffff");
    private final Color BRAND_PRIMARY_CONTAINER = Color.decode("#4f46e5");
    private final Color FOOTER_BG_MODAL = Color.decode("#f3f0ff"); // Warna background footer modal di gambar
    ...
    private void inisialisasiGUI() {
        ...
        JLabel lblAppTitle = new JLabel("🏪 POS Terminal");
        ...
        stickyCart.add(btnCheckoutBottom, BorderLayout.EAST);
    ...
    // ==========================================
    // CUSTOM MODAL BERDASARKAN SCREENSHOT BARU
    // ==========================================
    ...
    public JDialog createTambahModal() {
        ...
        // Menggunakan BoxLayout Y_AXIS agar penumpukan komponen presisi ke bawah
        ...
        // Tombol Simpan sebelah kanan kotak biru solid
        ...
        // Simpan referensi objek kontrol agar bisa diakses controller
